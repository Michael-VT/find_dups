...
```bash
cd find_dups_pthon
python3 find_dups_python_e.py /chemin/vers/scan1 /chemin/vers/scan2 ...
```
...
| Temps de hachage        | 1:49.337   | 2:07.520   | 1:31.992   |
| Temps total             | 4:10.790   | 3:55.664   | 3:06.040   |
| Doublons trouvés        | 920        | 696        | 696        |
| Workers/threads         | 12         | 12         | 12         |

**Notes** :
- Temps au format `minutes:secondes.millisecondes`
- Toutes les trois implémentations ont trouvé des doublons, montrant le bon fonctionnement de l'algorithme (Python: 920, Rust: 696, Go: 696)
...
1. **Discrepancy dans les doublons** : Python a trouvé 920 doublons tandis que Go/Rust en ont trouvé 696. Cela est dû au fait que Python a scanné plus de fichiers (149 044 vs 148 819).
...
1. **Investiguer la discrepancy** — pourquoi Python trouve plus de doublons que Go/Rust
...
10. **Déduplication par liens symboliques/durs** — Remplacer les doublons par liens durs pour économiser l'espace sans supprimer
